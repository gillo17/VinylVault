...
describe('Button Component Tests', () => {
    describe('Primary Button Tests', () => {
        it('should render a primary button', () => {
            const { getByText } = render(
                <Button label="Primary Button" theme="primary" size_width={200} onPress={() => {}} />
            )
        ...
        it('should call onPress when primary button is pressed', () => {
            ...
            const { getByText } = render(
                <Button label="Primary Button" theme="primary" size_width={200} onPress={mockOnPress} />
            )
    ...
    describe('Secondary Button Tests', () => {
        it('should render a secondary button', () => {
            const { getByText } = render(
                <Button label="Secondary Button" theme="secondary" size_width={200} onPress={() => {}} />
            )
        ...
        it('should call onPress when secondary button is pressed', () => {
            const mockOnPress = jest.fn()
            const { getByText } = render(
                <Button label="Secondary Button" theme="secondary" size_width={200} onPress={mockOnPress} />
            )
