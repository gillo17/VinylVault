...
class VinylHelper {
    ...
    public generateVinylAlbums(): albumData[] {
        return [
            ...
            { spotifyID: "2", albumName: 'Vinyl Album 2', artist: 'Artist 2', spotifyArtistID: "2", albumImage: 'https://example.com/image2.jpg' },
            { spotifyID: "3", albumName: 'Vinyl Album 3', artist: 'Artist 3', spotifyArtistID: "3", albumImage: 'https://example.com/image3.jpg' }
        ];
    }
